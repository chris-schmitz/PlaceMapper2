...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/PlaceMapper/map.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/cschmitz/Development/CS/WebCode/Demos/Vue/Not Part of Meetup presentation/PlaceMapper2/src/PlaceMapper/map.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n#map{\n    height:100%;\n    width:100%;\n}\n", "", {"version":3,"sources":["/./src/PlaceMapper/map.vue?142fa61a"],"names":[],"mappings":";AACA;IACA,YAAA;IACA,WAAA;CACA","file":"map.vue","sourcesContent":["<style>\n    #map{\n        height:100%;\n        width:100%;\n    }\n</style>\n\n<template>\n    <div id=\"map\">\n        {{ message }}\n    </div>\n</template>\n\n<script>\n    module.exports = {\n        data: function (){\n            return {\n                message: ''\n            }\n        },\n        ready: function (){\n            var GoogleMapsLoader = require('google-maps')\n            GoogleMapsLoader.KEY = require('./keys.js').key\n            GoogleMapsLoader.LIBRARIES = ['places']\n\n            GoogleMapsLoader.load((function (google){\n                this.map = document.getElementById('map')\n                var options = {\n                    center: {lat: 38.627003,lng: -90.199404},\n                    zoom: 15\n                }\n                new google.maps.Map(this.map, options)\n            }).bind(this))\n\n        },\n        methods: {\n            updateMessage: function(){\n                console.log('update message');\n                this.message = 'test'\n            }\n        }\n    }\n</script>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    ready: function ready() {
	        ...
	        GoogleMapsLoader.KEY = __webpack_require__(11).key;
	        GoogleMapsLoader.LIBRARIES = ['places'];
...
/***/ function(module, exports) {
	...
	module.exports = {
	    key: 'AIzaSyCXMFYBFJCX5ppwBXtpKyWmaa0pbqqt2OQ'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./mapper.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./mapper.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
